...
/* H618's VP9 engine reuses the H265 register group (CedarX group 5). */
#define VE_ENGINE_DEC_VP9			VE_ENGINE_DEC_H265
...
/* H618 VP9 decoder registers.  Names and offsets were recovered from the
 * Android libawvp9HwAL backend; semantics are deliberately added only as they
 * are mapped to standardized V4L2 request controls. */
#define VE_DEC_VP9_HDR_SYNC			(VE_ENGINE_DEC_VP9 + 0x04)
#define VE_DEC_VP9_PIC_SIZE			(VE_ENGINE_DEC_VP9 + 0x08)
#define VE_DEC_VP9_LAST_PIC_SIZE		(VE_ENGINE_DEC_VP9 + 0x0c)
#define VE_DEC_VP9_GOLDEN_PIC_SIZE		(VE_ENGINE_DEC_VP9 + 0x10)
#define VE_DEC_VP9_ALTREF_PIC_SIZE		(VE_ENGINE_DEC_VP9 + 0x14)
#define VE_DEC_VP9_LAST_SCALE0			(VE_ENGINE_DEC_VP9 + 0x18)
#define VE_DEC_VP9_LAST_SCALE1			(VE_ENGINE_DEC_VP9 + 0x1c)
#define VE_DEC_VP9_GOLDEN_SCALE0		(VE_ENGINE_DEC_VP9 + 0x20)
#define VE_DEC_VP9_GOLDEN_SCALE1		(VE_ENGINE_DEC_VP9 + 0x24)
#define VE_DEC_VP9_ALTREF_SCALE0		(VE_ENGINE_DEC_VP9 + 0x28)
#define VE_DEC_VP9_ALTREF_SCALE1		(VE_ENGINE_DEC_VP9 + 0x2c)
#define VE_DEC_VP9_FUNC_CTRL			(VE_ENGINE_DEC_VP9 + 0x30)
#define VE_DEC_VP9_TRIGGER			(VE_ENGINE_DEC_VP9 + 0x34)
#define VE_DEC_VP9_STATUS			(VE_ENGINE_DEC_VP9 + 0x38)
#define VE_DEC_VP9_STATUS_MASK			GENMASK(2, 0)
#define VE_DEC_VP9_DEC_CTB_NUM			(VE_ENGINE_DEC_VP9 + 0x3c)
#define VE_DEC_VP9_BITS_ADDR			(VE_ENGINE_DEC_VP9 + 0x40)
#define VE_DEC_VP9_BITS_OFFSET			(VE_ENGINE_DEC_VP9 + 0x44)
#define VE_DEC_VP9_BITS_LEN			(VE_ENGINE_DEC_VP9 + 0x48)
#define VE_DEC_VP9_BITS_END_ADDR		(VE_ENGINE_DEC_VP9 + 0x4c)
#define VE_DEC_VP9_SDRT_CTRL			(VE_ENGINE_DEC_VP9 + 0x50)
#define VE_DEC_VP9_SDRT_LUMA_ADDR		(VE_ENGINE_DEC_VP9 + 0x54)
#define VE_DEC_VP9_SDRT_CHROMA_ADDR		(VE_ENGINE_DEC_VP9 + 0x58)
#define VE_DEC_VP9_SEGMENT_FEATURE		(VE_ENGINE_DEC_VP9 + 0x5c)
#define VE_DEC_VP9_NEIGHBOR_ADDR		(VE_ENGINE_DEC_VP9 + 0x60)
#define VE_DEC_VP9_ENTRY_POINT_OFFSET_ADDR	(VE_ENGINE_DEC_VP9 + 0x64)
#define VE_DEC_VP9_TILE_START			(VE_ENGINE_DEC_VP9 + 0x68)
#define VE_DEC_VP9_TILE_END			(VE_ENGINE_DEC_VP9 + 0x6c)
#define VE_DEC_VP9_TQ_BYPASS_ADDR		(VE_ENGINE_DEC_VP9 + 0x70)
#define VE_DEC_VP9_VLD_BYPASS_ADDR		(VE_ENGINE_DEC_VP9 + 0x74)
#define VE_DEC_VP9_COL_MV_ADDR			(VE_ENGINE_DEC_VP9 + 0x78)
#define VE_DEC_VP9_ALTREF_CHROMA_ADDR		(VE_ENGINE_DEC_VP9 + 0x7c)
#define VE_DEC_VP9_ENTROPY_LOWER8		(VE_ENGINE_DEC_VP9 + 0x80)
#define VE_DEC_VP9_FIRST_OUTPUT_OFFSET_ADDR	(VE_ENGINE_DEC_VP9 + 0x84)
#define VE_DEC_VP9_10BIT_CONFIGURE		(VE_ENGINE_DEC_VP9 + 0x8c)
#define VE_DEC_VP9_CURRENT_LUMA_ADDR		(VE_ENGINE_DEC_VP9 + 0x90)
#define VE_DEC_VP9_CURRENT_CHROMA_ADDR		(VE_ENGINE_DEC_VP9 + 0x94)
#define VE_DEC_VP9_LAST_LUMA_ADDR		(VE_ENGINE_DEC_VP9 + 0x98)
#define VE_DEC_VP9_LAST_CHROMA_ADDR		(VE_ENGINE_DEC_VP9 + 0x9c)
#define VE_DEC_VP9_GOLDEN_LUMA_ADDR		(VE_ENGINE_DEC_VP9 + 0xa0)
#define VE_DEC_VP9_GOLDEN_CHROMA_ADDR		(VE_ENGINE_DEC_VP9 + 0xa4)
#define VE_DEC_VP9_ALTREF_LUMA_ADDR		(VE_ENGINE_DEC_VP9 + 0xa8)
#define VE_DEC_VP9_SEGMENT_ID_ADDR		(VE_ENGINE_DEC_VP9 + 0xb0)
#define VE_DEC_VP9_ERROR_CASE			(VE_ENGINE_DEC_VP9 + 0xb8)
#define VE_DEC_VP9_BASIC_RETURN_DATA		(VE_ENGINE_DEC_VP9 + 0xdc)
...
#define VE_DEC_VP9_10BIT_CONFIGURE_FIRST_2BIT_STRIDE(v) \
	SHIFT_AND_MASK_BITS(v, 11, 0)
#define VE_DEC_VP9_FUNC_CTRL_ROTATE_SCALE_OUT_EN	BIT(9)
...
#define VE_ISP_H618_CTRL_REG			(VE_ENGINE_ENC_ISP_BASE + 0xe4)

/* H.264 Encoder Registers */

#define VE_ENC_AVC_PARA0_REG			(VE_ENGINE_ENC_H264_BASE + 0x4)
#define VE_ENC_AVC_PIC_INFO_REG			(VE_ENGINE_ENC_H264_BASE + 0x0)
...
#define VE_ENC_AVC_PARA1_H618_MODE		BIT(27)
